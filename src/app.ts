  ...
  const UI = {
    ...
    renderDayView() {
      ...
      if (isToday) {
        ...
        const daysAgo = Math.ceil((today.getTime() - date.getTime()) / 86400000);
    ...
    // Modal Handling
    // ============================================
    openGoalModal(preselectedMonth: number | null = null, preselectedYear: number | null = null): void {
      this.goalModalYear =
