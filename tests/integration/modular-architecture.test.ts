...
describe('Modular Architecture Integration', () => {
  ...
  describe('DataStore Integration', () => {
    ...
    test('should handle subscribers correctly', () => {
      ...
      unsubscribe1();
      dataStore.updateData({ preferences: { ...testData.preferences, focusMode: true } });
  ...
  describe('Error Recovery', () => {
    test('should provide recovery options for different error types', () => {
      const testCases = [
        {
          ...
          expectedUserMessage: 'Connection problem. Check your internet connection.'
        },
        {
        ...
        },
        {
          ...
          expectedRecoverable: true,
          expectedUserMessage: 'Storage problem. Your data may not be saved properly.'
        },
        {
          type: ErrorType.SYNC,
          expectedRecoverable: true,
          expectedUserMessage: 'Sync problem. Your changes will be saved locally.'
        },
        {
          type: ErrorType.UI,
          expectedRecoverable: true,
      ...
      testCases.forEach(({ type, expectedRecoverable, expectedUserMessage }) => {
