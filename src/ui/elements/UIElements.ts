...
export function cacheElements(): UIElements {
  ...
  return {
    ...
    levelContextBar: document.getElementById("levelContextBar") as HTMLElement | null,
    ...
    daysLeftLabel: document.getElementById("daysLeftLabel") as HTMLElement | null,
    weeksLeft: document.getElementById("weeksLeft") as HTMLElement | null,
    weeksLeftLabel: document.getElementById("weeksLeftLabel") as HTMLElement | null,
